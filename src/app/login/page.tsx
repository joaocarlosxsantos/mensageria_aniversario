...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
      <form onSubmit={handleLogin} className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md border border-gray-200">
        <h1 className="text-3xl font-extrabold mb-6 text-center text-indigo-800 tracking-tight drop-shadow">Entrar</h1>
        ...
        <div className="mb-4">
          ...
          <input type="email" className="w-full border-2 border-indigo-200 focus:border-indigo-500 rounded-lg px-3 py-2 text-gray-900 bg-gray-50 focus:bg-white transition" value={email} onChange={e => setEmail(e.target.value)} required autoFocus />
        </div>
        <div className="mb-6">
        ...
        <div className="mt-6 text-center text-base text-gray-700">
          Não tem conta? <a href="/cadastrar" className="text-indigo-700 hover:underline font-semibold">Cadastre-se</a>
        </div>
      </form>
    </div>
  );
