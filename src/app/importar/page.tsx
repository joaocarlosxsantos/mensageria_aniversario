        ...
        <main className="flex-1 md:ml-0 pt-16 md:pt-8 px-4 md:px-12 pb-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6 md:mb-8">
              ...
              <p className="text-gray-600 text-sm md:text-base">Faça upload de uma planilha para importar seus contatos{user ? `, ${user.name}` : ""}</p>
            </div>
            ...
            <section className="mb-6 md:mb-8">
              <div className="bg-white rounded-xl shadow p-4 md:p-6 flex flex-col gap-4 border border-blue-100">
                ...
                <form onSubmit={handleUpload} className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 rounded-lg shadow transition-colors text-lg tracking-wide cursor-pointer disabled:opacity-60"
                    disabled={uploading}
                  >
