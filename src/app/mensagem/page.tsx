          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6 md:mb-8">
              ...
              <p className="text-gray-600 text-sm md:text-base">
                Configure a mensagem que será enviada automaticamente nos aniversários{user ? `, ${user.name}` : ""}.
              </p>
            </div>
            ...
            <section className="mb-6 md:mb-8">
              <div className="bg-white rounded-xl shadow p-4 md:p-6 flex flex-col gap-4 border border-green-100">
                ...
                <form onSubmit={handleConfigSave} className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow transition-colors text-lg tracking-wide cursor-pointer disabled:opacity-60"
